...
class Ville:
    def __init__(self, name, money, population, Augmentationmoney = 0.03, Annee = 0):
        self.money = money
        self.name = name
        self.Annee = Annee
        self.tauxcarbon = 8
        ...
        self.Augmoney = Augmentationmoney

    def augmentermoney(self):
        self.money += self.money*self.Augmoney
    ...
    def DeveloperTransport(self):
        ...
        self.money -= (facteurqualite*(self.tranchedages[1] + self.tranchedages[0]))*(10**(-3))
        self.tauxcarbon -= 0.5
        self.emissioncarbone = self.population*self.tauxcarbon + self.infrastructure["Peu Polluantes"]*800 + self.infrastructure["Moyennement Polluantes"]*1200 + self.infrastructure["Très Polluantes"]*2000
